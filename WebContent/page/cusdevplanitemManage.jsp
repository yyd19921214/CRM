	...
	var url;
	 ...
	 $(function(){
		 ...
		 $.post("${pageContext.request.contextPath}/saleChance/findById.do",{id:'${param.saleChanceId}'},function(result){
				...
				$("#assignMan").val(result.assignMan.trueName);
...
<table id="dg" title="开发计划项" style="width:700px;height:250px"
    ...
    <thead>
        <tr>
            ...
            <!--  <th field="cusDevMethod.content" width="100" editor="{type:'validatebox',options:{validType:'date'}}">标准化方法</th>-->
           <!-- <th width="100" id="method" name="method">使用标准方法</th> --> 
        </tr>
    </thead>
</table>
...
<c:if test="${param.show=='true' }">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-redo" plain="true" onclick="updateSaleChanceDevResult(1)">重新开发</a>
</c:if>
</div>
