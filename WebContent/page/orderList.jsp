	...
	var url;
     ...
     function searchOrder(){
    	 $("#dg").datagrid('load',{
 			...
 			"orderTimeFrom":$("#s_orderTimefrom").datebox("getValue"),
 			"orderTimeTo":$("#s_orderTimeto").datebox("getValue")
...
<table id="dg" title="客户历史订单" class="easyui-datagrid"
 fitColumns="true" fit="true" pagination="true" rownumbers="true" style="height: 400px" singleSelect="true"
 url="${pageContext.request.contextPath}/order/listAll.do" toolbar="#tb" >
 <thead>
 	<tr>
	...
	<div id="tb">
		<div>
			&nbsp;订单编号：&nbsp;<input type="text" id="s_orderno" size="20" onkeydown="if(event.keyCode==13) searchOrder()" />&nbsp;
			&nbsp;订单日期：&nbsp;从&nbsp;<input type="text" id="s_orderTimefrom" class="easyui-datebox" editable="false">&nbsp;至&nbsp;<input type="text" id="s_orderTimeto" class="easyui-datebox" editable="false">&nbsp;
			&nbsp;订单状态：&nbsp;
