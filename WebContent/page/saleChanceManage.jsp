...
<script type="text/javascript">
	...
	function exportExcel(){
		//$.post("${pageContext.request.contextPath}/saleChance/exportExcel.do");
		location.href="${pageContext.request.contextPath}/saleChance/exportExcel.do";
	}
	...
	function openSaleChanceModifyDialog(){
		...
		$("#assignMan").combobox("setValue",row.assignMan.trueName);
	...
	<table id="dg" title="销售机会管理" class="easyui-datagrid"
	 ...
	 <thead>
	 	<tr>
	 		...
	 		<th field="assignMan.trueName" width="50" align="center" hidden="true">指派人</th>
	 	...
	 	<form id="fm" method="post">
	 		<table cellspacing="8px">
	 			...
	 			<tr>
	 				<td>指派给：</td>
	 				<td>
	 					<input class="easyui-combobox" id="assignMan" name="assignMan.id" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'trueName',url:'${pageContext.request.contextPath}/user/customerManagerComboList.do'"/>
					</td>
	 				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	 				<td>指派时间：</td>
